...
const upcomingMedia = [
  { src: ev.url, alt: "Solar-powered electric vehicle charging points beside a road" },
  { src: kids.url, alt: "Smiling schoolchildren sharing a nutritious midday meal" },
  { src: sustain.url, alt: "Community gathering learning about solar lamps and energy efficiency" },
  { src: volunteersImg.url, alt: "Volunteers joining hands together in a circle" },
];
...
export default function Home() {
  return (
    <>
      {/* Hero */}
      <section className="relative isolate min-h-[92dvh] overflow-hidden bg-forest-deep">
        <img
          src={hero.url}
        ...
        <div className="relative mx-auto flex min-h-[92dvh] max-w-[80rem] flex-col justify-end px-5 pt-36 pb-16 lg:px-10 lg:pb-24">
          <Reveal>
            ...
            <p className="mt-8 max-w-2xl text-lg leading-relaxed text-ivory/80">
              Rajavasantha Welfare Trust works towards inclusive social development through
              education, healthcare, community welfare, environmental sustainability,
            ...
            <div className="mt-10 flex flex-col gap-3 sm:flex-row">
              ...
              <ActionLink to="/focus-areas" variant="outlineLight">
      ...
      <section className="bg-ivory">
        <div className="mx-auto max-w-[80rem] px-5 py-20 lg:px-10 lg:py-32">
          <div className="grid gap-14 lg:grid-cols-[0.85fr_1.15fr] lg:gap-24">
            ...
            <Reveal delay={80} className="space-y-6 text-[1.05rem] leading-relaxed text-muted-foreground">
              <p>
                Rajavasantha Welfare Trust has been established as a charitable trust for
                public, educational, cultural, welfare and charitable purposes. Its founding
                trustees came together in Bengaluru in 2026 to create an institution capable
                of serving communities over the long term.
              </p>
              <p>
                The Trust Deed sets out objectives that span education and skill development,
                healthcare, nutrition, women and child development, community and rural
                development, renewable energy, environmental sustainability, sports and youth
                development, elderly care, animal welfare and disaster relief.
              </p>
              <p className="text-forest-soft">
                The Trust is at the beginning of its journey. What follows describes what it
                is established to do — the objectives entrusted to it by its deed.
              </p>
              <Link href="/about" className="link-underline font-medium text-forest-deep">
                Learn about the Trust <ArrowRight className="h-4 w-4 text-gold" />
              </Link>
            </Reveal>
          </div>
        </div>
      ...
      <section className="border-y border-forest-deep/10 bg-card">
        <div className="mx-auto max-w-[80rem] px-5 py-20 lg:px-10 lg:py-28">
          <Reveal className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            ...
            <Link href="/focus-areas" className="link-underline font-medium text-forest-deep">
              View all focus areas <ArrowRight className="h-4 w-4 text-gold" />
            </Link>
          </Reveal>

          <div className="mt-14 grid gap-px border border-forest-deep/10 bg-forest-deep/10 sm:grid-cols-2 lg:grid-cols-3">
            {focusAreas.map((area, i) => (
              <Reveal key={area.slug} delay={(i % 3) * 70}>
                <Link
                ...
                >
                  <area.icon
                    ...
                    aria-hidden="true"
                  />
                  <h3 className="mt-6 font-display text-xl text-forest-deep">{area.title}</h3>
      ...
      <section className="bg-ivory">
        <div className="mx-auto max-w-[80rem] px-5 py-20 lg:px-10 lg:py-28">
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
            ...
            <Reveal delay={90}>
              <p className="eyebrow">Change begins when we choose to participate</p>
              <h2 className="display-lg mt-6 text-forest-deep">
              ...
              <dl className="mt-10 divide-y divide-forest-deep/10 border-y border-forest-deep/10">
                {[
                  ...
                  <div key={item.t} className="grid gap-2 py-6 sm:grid-cols-[9rem_1fr]">
              ...
              <div className="mt-10 flex flex-col gap-3 sm:flex-row">
                <ActionLink to="/support" variant="forest">
                  Support the Trust
                </ActionLink>
      ...
      <section className="bg-forest-deep text-ivory">
        <div className="mx-auto max-w-[80rem] px-5 py-20 lg:px-10 lg:py-28">
          <Reveal>
            <p className="eyebrow">Our upcoming work</p>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-relaxed text-ivory/75">
              These are intended directions of work under the Trust&apos;s objectives. They are
              not yet operational programmes.
            </p>
          </Reveal>
      ...
      <section className="bg-ivory">
        <div className="mx-auto max-w-[80rem] px-5 py-20 lg:px-10 lg:py-28">
          <Reveal className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div>
              <p className="eyebrow">Guided by purpose</p>
              <h2 className="display-lg mt-6 max-w-2xl text-forest-deep">
                The commitments written into our deed.
              </h2>
            </div>
            <Link href="/principles" className="link-underline font-medium text-forest-deep">
              Explore our principles <ArrowRight className="h-4 w-4 text-gold" />
            </Link>
          </Reveal>
      ...
      <section className="relative isolate overflow-hidden bg-forest">
        ...
        <div className="relative mx-auto max-w-3xl px-5 py-24 text-center lg:py-32">
          <Reveal>
            <h2 className="display-lg text-ivory">Help build the capacity to serve.</h2>
            <p className="mx-auto mt-6 max-w-xl text-lg leading-relaxed text-ivory/80">
              Your support can help Rajavasantha Welfare Trust pursue its charitable and
              welfare objectives across communities.
            </p>
            <div className="mt-10 flex flex-col justify-center gap-3 sm:flex-row">
              <ActionLink to="/support" variant="gold">
                Support the Trust
              </ActionLink>
              <ActionLink to="/contact" variant="outlineLight">
                Contact the Trust
              </ActionLink>
            </div>
          </Reveal>
